...
const styles = StyleSheet.create({
  ...
  reportHead: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14 },
  ...
  reportBody: { paddingHorizontal: 14, paddingBottom: 14, gap: 10 },
  reasonsRow: { flexDirection: 'row', alignItems: 'center', gap: 6, flexWrap: 'wrap' },
  reasonChip: {
