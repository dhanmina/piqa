...
const styles = StyleSheet.create({
  ...
  memberHead: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: space.smPlus },
  ...
  actions: { paddingHorizontal: space.smPlus, paddingBottom: space.smPlus, gap: space.xsPlus },
